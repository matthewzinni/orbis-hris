...
import { HANDBOOK_ACKNOWLEDGMENT_TEXT, HANDBOOK_DOCUMENT_TITLE } from '../services/handbookAcknowledgments';

const record = {
  id: 'record-1', employee_id: 'E1', employee_name: 'Test Employee',
  document_title: HANDBOOK_DOCUMENT_TITLE, acknowledgment_text: HANDBOOK_ACKNOWLEDGMENT_TEXT,
...
describe('signed handbook record', () => {
  it('preserves the issued wording, employee, signature and recorded timestamp', () => {
    ...
    expect(html).toContain(HANDBOOK_DOCUMENT_TITLE);
