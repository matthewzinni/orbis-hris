...
function populateEmployeeForm(employee) {
    ...
    if (safeGet('firstName')) {
        safeGet('firstName').value = cleanEmployeeFormNameValue(employee.first_name || employee.first || '');
    }

    if (safeGet('lastName')) {
        safeGet('lastName').value = cleanEmployeeFormNameValue(employee.last_name || employee.last || '');
    }
