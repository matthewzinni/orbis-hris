-- orbis_ensure_employee_portal_access failed silently when supervisor_name NOT NULL
-- and the insert omitted that column (employees like Teresa Gravel stayed role=user).
